...
class VAExciterProcessor : public juce::AudioProcessor
{
public:
    VAExciterProcessor();
    ~VAExciterProcessor() override = default;
    ...
    const juce::String getName() const override { return "VA Exciter"; }
...
private:
    ...
    // Cascaded 2nd-order LP/HP crossover (two biquads each)
    ...
    JUCE_DECLARE_NON_COPYABLE_WITH_LEAK_DETECTOR(VAExciterProcessor)
};
